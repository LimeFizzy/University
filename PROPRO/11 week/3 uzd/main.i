...
int main(){
    int *m1 = ((void *)0), *m2 = ((void *)0), *m3 = ((void *)0);
    int cap;
    m1 = malloc(20 * sizeof(int));
    m2 = malloc(20 * sizeof(int));
    m3 = malloc(20 * sizeof(int));

    fillArray(m1, 20);
    fillArray(m2, 20);
    fillArray(m3, 20);

    saveToFile(m1, 20, "db1.bin");
    saveToFile(m3, 20, "db1.bin");

    loadFromFile(m1, &cap, "db1.bin");

    saveToFile(m2, 20, "db2.bin");
